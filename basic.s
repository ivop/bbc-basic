...
L93DA:
    ...
    jsr WRIACC
    jmp NXT         ; Send IntA to OSWRCH, jump to execution loop
...
L93FD:
    ...
    lda zpWORK+1
    jsr OSWRCH
    jsr WRIACC         ; Send IntA to OSWRCH, second coordinate
    lda zpIACC+1
...
L9CA7:
    stx zpTYPE
    jsr POPACC         ; Unstack integer to IntA
    jsr PHFACC
    jsr IFLT         ; Stack float, convert integer in IntA to float in FPA1
